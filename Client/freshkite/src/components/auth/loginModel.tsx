...
const LoginModal = () => {
    ...
    const handleSuccess = async (credentialResponse: CredentialResponse) => {
        ...
        try {
            ...
            console.log('User data:', data); // Handle user data, e.g., save to state

            // Redirect to the courses page on successful login
            router.push('/course'); // <-- Redirect after success
        } catch (error) {
